...
<div className='flex align-middle gap-4  '>
  ...
  <div className='justify-self-end text-[5.4rem] font-semibold text-[#a4d3e776]'>{info.num}</div>
    ...
    <div className='flex p-4 hover:shadow-lg duration-200 transition-all shadow-md rounded-lg bg-[#f5f6f7] flex-wrap  align-middle justify-around mb-[6rem] '>
{/* img */}
<div>
...
<div className=' lg:text-center self-start '>
  <h1 className='text-center text-[1.5rem] font-medium leading-[4rem] text-[#6c6c6c]'>{info.title}</h1>
...
<div className='mt-5 flex gap-8 align-middle justify-center text-[1.2rem]'>
  ...
  {/* Demo */}
  <a href='#/' className='border-2 rounded-full p-2 border-[#ADD6E8] hover:bg-[#ADD6E8] transition-all duration-500 text-[#4d4d4d]'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
