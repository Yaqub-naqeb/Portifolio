...
{/* tools */}
<div className={`flex ${id==3?'lg:translate-x-[3.8rem] md:translate-x-[2rem]  ':''} lg:translate-x-[3rem]  m-[2rem] lg:gap-0  md:gap-2  gap-2 text-center text-[#306CC4] font-medium text-[1rem]`}>
