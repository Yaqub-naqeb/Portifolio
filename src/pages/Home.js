...
{/* the blue rectaingul */}
        ...
        bg-[#ADD6E84F]'/>
{/* Writting */}
        <div className='writting -z-50 absolute top-[28%] lg:left-[11%] md:left-[23%] left-10  '>
...
{/* rectangul with socials */}
          ...
          <div className='flex -z-50 gap-4 absolute bottom-9 lg:pl-[10rem] md:pl-[7rem] pl-[3rem] py-[7px] pr-8 bg-[#ADD6E84F]'>
